...
int main (int argc, char* argv[]) {
  ...
  TH1D *hist_dwg_bg_mu_mom = new TH1D("hist_dwg_bg_mu_mom", "", 20, 0., 2000.);
  TH1D *hist_dwg_bg_mu_mom_mcs = new TH1D("hist_dwg_bg_mu_mom_mcs", "", 20, 0., 2000.);
  TH1D *hist_dwg_bg_mu_mom_range = new TH1D("hist_dwg_bg_mu_mom_range", "", 20, 0., 2000.);

  TH1D *hist_dwg_bg_mu_mom_mcs_all = new TH1D("hist_dwg_bg_mu_mom_mcs_all", "", 20, 0., 2000.);

  TH1D *hist_dwg_bg_mu_cos = new TH1D("hist_dwg_bg_mu_cos", "", 20, 0., 1.);
  TH1D *hist_dwg_bg_mu_deg = new TH1D("hist_dwg_bg_mu_deg", "", 18, 0., 90.);

  TH1D *hist_dwg_bg_pi_mom = new TH1D("hist_dwg_bg_pi_mom", ";Reconstructed momentum [MeV/c];Entries", 15, 0., 1500.);
  TH1D *hist_dwg_bg_pi_mom_mcs = new TH1D("hist_dwg_bg_pi_mom_mcs", ";Reconstructed momentum [MeV/c];Entries", 15, 0., 1500.);
  TH1D *hist_dwg_bg_pi_mom_range = new TH1D("hist_dwg_bg_pi_mom_range", ";Reconstructed momentum [MeV/c];Entries",
					   15, 0., 1500.);
  TH1D *hist_dwg_bg_p_mom = new TH1D("hist_dwg_bg_p_mom", ";Reconstructed momentum [MeV/c];Entries", 15, 0., 1500.);
  TH1D *hist_dwg_bg_p_mom_mcs = new TH1D("hist_dwg_bg_p_mom_mcs", ";Reconstructed momentum [MeV/c];Entries", 15, 0., 1500.);
  TH1D *hist_dwg_bg_p_mom_range = new TH1D("hist_dwg_bg_p_mom_range", ";Reconstructed momentum [MeV/c];Entries",
					  15, 0., 1500.);
  TH1D *hist_dwg_bg_pi_cos = new TH1D("hist_dwg_bg_pi_cos", ";Reconstructed angle;Entries", 40, -1., 1.);
  TH1D *hist_dwg_bg_pi_deg = new TH1D("hist_dwg_bg_pi_deg", ";Reconstructed angle [degree];Entries", 36, 0., 180.);
  TH1D *hist_dwg_bg_p_cos = new TH1D("hist_dwg_bg_p_cos", ";Reconstructed angle;Entries", 40, -1., 1.);
  TH1D *hist_dwg_bg_p_deg = new TH1D("hist_dwg_bg_p_deg", ";Reconstructed angle [degree];Entries", 36, 0., 180.);
