...
int main (int argc, char* argv[]) {
  ...
  TH1D *hist_wall_bg_pi_mom = new TH1D("hist_wall_bg_pi_mom", ";Reconstructed momentum [MeV/c];Entries", 50, 0., 1500.);
  TH1D *hist_wall_bg_pi_mom_mcs = new TH1D("hist_wall_bg_pi_mom_mcs", ";Reconstructed momentum [MeV/c];Entries", 50, 0., 1500.);
  TH1D *hist_wall_bg_pi_mom_range = new TH1D("hist_wall_bg_pi_mom_range", ";Reconstructed momentum [MeV/c];Entries",
					   50, 0., 1500.);
  TH1D *hist_wall_bg_p_mom = new TH1D("hist_wall_bg_p_mom", ";Reconstructed momentum [MeV/c];Entries", 50, 0., 1500.);
  TH1D *hist_wall_bg_p_mom_mcs = new TH1D("hist_wall_bg_p_mom_mcs", ";Reconstructed momentum [MeV/c];Entries", 50, 0., 1500.);
